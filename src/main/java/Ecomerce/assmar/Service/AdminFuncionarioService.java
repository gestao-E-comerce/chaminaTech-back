...
import Ecomerce.assmar.DTO.AdminFuncionarioDTO;
...
import Ecomerce.assmar.Repository.AdminFuncionarioRepository;
...
public class AdminFuncionarioService {
    ...
    public List<AdminFuncionarioDTO> listarAdminFuncionarios(Long adminId, Boolean deletado, String termoPesquisa, Boolean ativo) {
        return adminFuncionarioRepository.buscarFuncionarios(adminId, deletado, termoPesquisa, ativo).stream().map(entityToDTO::adminFuncionarioToDTO).collect(Collectors.toList());
    }
